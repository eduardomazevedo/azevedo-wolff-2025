...
Throughout this section, fix an interior intended action $a_0>0$. To simplify notation, we omit the dependence on $a_0$ whenever it is clear, writing, for example, $U(v)$ instead of $U(v, a_0)$.
