...
The formulae imply linear contracts in many examples. The key ingredients are log utility, which makes the wage function linear in the score, and a linear score function. This includes an exponential family with linear sufficient statistics. That is, when $f(y, a)$ is of the form
\begin{equation}
