...
Table~\ref{tab:benchmarks} reports the results. Algorithm~1 is substantially faster than the convex solver for the cost minimization problem, typically by a factor of 20--140$\times$. The advantage is especially pronounced for the principal's problem, where Algorithm~1 is 2--300$\times$ faster.
