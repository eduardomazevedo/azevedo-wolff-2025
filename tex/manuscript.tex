...
\usepackage{xr}
\externaldocument{pdf/si}

\begin{document}
\title{Broad Validity of the First-Order Approach in Moral Hazard%
\thanks{We are especially grateful to Lucas Maestri for originating key ideas in this paper. We thank Daniel Gottlieb, Rongzhu Ke, Humberto Moreira, Marcus Opp, and Juuso Toikka for valuable comments. Replication code is available at \url{https://github.com/eduardomazevedo/azevedo-wolff-2025}, and supplementary information is available at \url{https://eduardomazevedo.github.io/papers/azevedo-wolff-foa-supplementary-material.pdf}.}
}
