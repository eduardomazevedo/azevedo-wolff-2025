...
\begin{figure}[p]
    ...
    \captionsetup{font=footnotesize} % Makes the note footnote-sized
    \caption{Optimal contracts with Gaussian output and CARA utility.}
