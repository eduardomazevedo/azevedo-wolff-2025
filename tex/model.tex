...
\footnote{The most unusual assumption is the third one. It holds for example in Gaussian, logistic, Laplace, and Student-$t$ location families. Examples that do not satisfy the assumption can be constructed with families of distributions where this second derivative oscillates in the left tail.}
