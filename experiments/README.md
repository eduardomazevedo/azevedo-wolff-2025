...
Outcome supports are expanded adaptively until grid mass and score-mean tolerances pass. Relaxed contracts at transition endpoints are additionally re-solved on baseline, denser, and expanded-support grids; classification or expected-wage instability is retained as unresolved.
