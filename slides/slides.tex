...
\begin{frame}{What is actually true}
  \begin{itemize}
    ...
    \item Key theorem assumptions: some risk aversion and $f_aa(y|a) > 0$ in a large enough region of low scores.
    \item Side effects:
    \begin{itemize}
...
\begin{frame}{Calculus}
  \begin{itemize}
    ...
    \item Calculus of moral hazard has two parts: link function and score.
  \end{itemize}
\end{frame}

\begin{frame}[plain]
  \centering
  \input{../tex/tables/utility_functions}
\end{frame}
