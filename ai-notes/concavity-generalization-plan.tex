...
We maintain \textbf{canonical-contract regularity}: every canonical utility
...
Finally, we maintain \textbf{local implementability}:
\begin{equation}
...
\[
 ...
 \in\R\cup\{\infty\}.
\]
The limit exists because $\widetilde U$ is nondecreasing.  The phrase
