...
\begin{enumerate}
 ...
 \item \textbf{Applications.}  Verify the aggregate conditions for the main
 distribution families and connect them to the numerical examples.  Keep the
 common-utility corollary near the main theorem rather than repeating separate
 utility theorems here.
...
\begin{enumerate}
 ...
 for links, capacities, and curvature bounds.
\end{enumerate}
