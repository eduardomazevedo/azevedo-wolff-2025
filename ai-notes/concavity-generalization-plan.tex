...
\begin{enumerate}
 ...
 \item \textbf{Scope.}  State clearly that the paper studies the cost-minimization
 problem for a fixed interior intended action $a_0$.  Keep the main theorem and its
 corollaries at this action-by-action level; do not add a separate theorem or an
 extended discussion of the principal's endogenous-action problem.
\end{enumerate}
